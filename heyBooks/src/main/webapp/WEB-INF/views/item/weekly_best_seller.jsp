	...
	<div class="container overhidden">
		...
		<div class="sub_right_box best_seller_right">
			...
			<ul class="nav nav-tabs best_seller_nav">
				<li class="nav-item">
					<a class="nav-link active" href="<c:url value='weekly_best_seller'/>">주간 베스트셀러</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<c:url value='monthly_best_seller'/>">월간 베스트셀러</a>
				</li> 
			</ul>
				...
				<form class="best_seller_date_form" id="small_cate_form" method="post">
					<div class="itemList_top_menu"> 
						<div class="best_seller_date">
							...
							<input type="button" search_id="weekly_best_seller" class="btn btn-primary week_search_btn" value="검색">
						</div>  
					...
					<div class="itemList_array_menu">
						...
						<div class="best_seller_info">
							<p><span class="year_txt"></span>년도 <span class="month_txt"></span>월 <span class="week_txt"></span>째주 베스트셀러</p>
						</div> 
					</div> 
