			...
			<div class="national_category_box">
				...
				<div id="category_best"> 
					...
					<ul class="book_item_list">
						<c:forEach var="list" items="${new_item_list}" begin="0" end="4" varStatus="status">
							<c:choose>
								...
								<c:otherwise>
									<li class="item_other_list"><span>${status.count }</span><p><a>${list.PRODUCT_NAME}</a></p></li>
								</c:otherwise>
							</c:choose>
