			...
			<ul>
				<li>
					...
					<div class="list_layout_right list_content event_content">
						...
						<div>
							<p>
								<span class="point_txt">기간</span><span class="event_content_txt">2019.08.30
									~ 2019.9.30</span>
							</p>
							<p>
								<span class="point_txt">내용</span><span class="event_content_txt">
									130주 베스트셀러 빅 픽처의 저자, 더글라스 케네디 작가전 OPEN <br> 1. 세트 4종 구매
									10% 할인 <br> 2. 단행본 14종 구매 10% 할인
								</span>
							</p>
						</div>
					</div>
