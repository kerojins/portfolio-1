...
public class Item_Vo {
	...
	public Item_Vo(int product_num, int cate_num, int editor_num, String product_publish, String product_name,
			...
			String product_view, String product_shipping_charge, String product_discount, int product_price,
			int product_stock, String product_picture, String product_preview, Date product_date) {
		super();
	...
	public String toString() {
		return "Item_Vo [product_num=" + product_num + ", cate_num=" + cate_num + ", editor_num=" + editor_num
				...
				+ product_price + ", product_stock=" + product_stock + ", product_picture=" + product_picture
				+ ", product_preview=" + product_preview + ", product_date=" + product_date + "]";
	}
