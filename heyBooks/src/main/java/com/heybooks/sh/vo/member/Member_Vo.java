...
public class Member_Vo {
	...
	public Member_Vo(int members_num, String members_id, String members_password, String members_name,
			...
			String members_add_number, String members_job, String members_favorite, Date members_regdate) {
		super();
	...
	public String toString() {
		return "Member_Join_Vo [members_num=" + members_num + ", members_id=" + members_id + ", members_password="
				...
				+ ", members_favorite=" + members_favorite + ", members_regdate=" + members_regdate + "]";
	}
